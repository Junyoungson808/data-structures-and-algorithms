...
const getNames = (arr) => {
  // let names = arr.map(('value') => value.name);
  // let reversedString = names.split("").reverse().join("");
...
// const asdf3 = function(p1)

// console.log(' CONSOLE LOG THIS ',getNames([{name:'lloyd', age: 32, shoeSize: 12}, {name:'jamie', age:21, shoeSize: 8}]));
